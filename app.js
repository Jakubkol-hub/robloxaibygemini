...
async function generateResponse() {
    ...
    const sendBtnIcon = sendPromptBtn.querySelector('i');
    sendBtnText.textContent = 'Generating...';
    sendBtnIcon.setAttribute('data-lucide', 'loader-2');
    sendBtnIcon.classList.add('spinner-icon');
    lucide.createIcons();
...
My request is: ${prompt}`;
    ...
    try {
        ...
        sendBtnIcon.setAttribute('data-lucide', 'sparkles');
        sendBtnIcon.classList.remove('spinner-icon');
        lucide.createIcons();
    }
}
...
async function syncCodeToStudio() {
    ...
    const spinnerIcon = syncCodeBtn.querySelector('.spinner-icon');
    ...
    try {
        ...
        syncCodeBtn.disabled = false;
        syncText.textContent = 'Sync to Roblox Studio';
